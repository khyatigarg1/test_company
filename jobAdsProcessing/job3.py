...
ofname_prefix = '/Users/ranziv/Downloads/job3/output/'
#ofname_prefix = '/Users/ranziv/Downloads/corpus_snapshot-2020-06-09'
# ofname_prefix = '/home/ranziv/jpl/output/'
#ofname = '/Users/ranziv/Downloads/corpus_snapshot-2020-06-09'+execution_dt+'.json.gz'
#ofname = '/home/ranziv/jpl/output/corpus_snapshot-2020-06-09'+execution_dt+'.json.gz'
...
for line in f:
    if min_record <= i and i < max_record:
        ...
        try:
            ...
            # fingerprint = fprint.generate(json_content['description'])
